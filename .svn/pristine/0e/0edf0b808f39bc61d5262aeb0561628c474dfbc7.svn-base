...
public class ChangePwdFragment extends Fragment implements View.OnClickListener{
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        btnChangePwdSubmit.setBackgroundColor(getResources().getColor(R.color.primary_dark));
        ((BaseThemeActivity) getActivity()).applyTheme(btnChangePwdSubmit, R.color.primary_dark, background_color);
