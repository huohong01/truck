    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        doNotDisturb.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked) {
                manager.setDoNotDisturb(isChecked);
                Log.i(TAG, "onCheckedChanged: switch is selected " +isChecked);
            }
        });
...
//--------------------------------------------------------------------------------------------------
    ...
    private void loadUser() {
        ...
        if (NetMeApp.currentUserHasValidAvatarUrl()) {
            ...
            avatar.setImageResource(R.drawable.empty_avatar_user);
            applyTheme(avatar,R.drawable.empty_avatar_user);
        }
    }
    ...
    private void setupPager() {
      ...
      //  slidingTabLayout.setSelectedIndicatorColors(ContextCompat.getColor(this, R.color.tab_indicator));
        slidingTabLayout.setSelectedIndicatorColors(applyThemeStatusBar(R.color.tab_indicator));
    ...
    private void setupToolbar() {
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            ...
            applyTheme(toolbar,R.drawable.menu_overflow,toolbar_overflow_icon);
        }
