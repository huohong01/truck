 ...
 */
public class PaymentSourceAdapter extends ArrayAdapter<PaymentSources> {
    ...
    private ArrayList<PaymentSources> items;
        ...
        public PaymentSourceAdapter(Context context, ArrayList<PaymentSources> items) {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (convertView == null) {
                convertView = LayoutInflater.from(getContext()).inflate(R.layout.list_payment_source, parent, false);
