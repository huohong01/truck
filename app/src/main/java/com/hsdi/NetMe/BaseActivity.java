...
public class BaseActivity extends BaseThemeActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
      ...
      //  StatusBarCompat.setStatusBarColor(this, getResources().getColor(R.color.primary_dark), true);
        StatusBarCompat.setStatusBarColor(this, applyThemeStatusBar(R.color.status_color), false);
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
            getWindow().setNavigationBarColor(applyThemeStatusBar(R.color.status_color));
        }

        NetMeApp.getInstance().addActivity(this);
    ...
    protected void onDestroy() {
        super.onDestroy();
        NetMeApp.getInstance().removeActivity(this);
    }
