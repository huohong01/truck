...
package com.hsdi.NetMe.ui.main.slidingtab;
...
public class SlidingTabLayout extends HorizontalScrollView {
    ...
    private void populateTabStrip() {
        ...
        tabViewArr = new View[adapter.getCount()];
        ...
        for (int i = 0; i < adapter.getCount(); i++) {
            ...
            // store a reference to the tab view for later use
            tabViewArr[i] = tabView;

//            tabTitleView.setText(adapter.getPageTitle(i));
            setupTabIcon(tabView, i);      // setup custom tab icon
    ...
    /** Custom tab icon added by Chau */
    private void setupTabIcon(View tabView, int position) {
        ImageView imageView = (ImageView) tabView.findViewById(R.id.tab_image);

        if (imageView != null) {
            switch (position) {
                case 0:
                    imageView.setImageResource(R.drawable.tabs_messages_selector);
                    ((BaseThemeActivity) getContext()).applyTheme(imageView,R.drawable.tabs_messages_selector);
                    break;
                case 1:
                    imageView.setImageResource(R.drawable.tabs_recent_selector);
                    ((BaseThemeActivity) getContext()).applyTheme(imageView,R.drawable.tabs_recent_selector);
                    break;
                case 2:
                    imageView.setImageResource(R.drawable.tabs_contacts_selector);
                    ((BaseThemeActivity) getContext()).applyTheme(imageView,R.drawable.tabs_contacts_selector);
                    break;
                case 3:
                    imageView.setImageResource(R.drawable.tabs_favorites_selector);
                    ((BaseThemeActivity) getContext()).applyTheme(imageView,R.drawable.tabs_favorites_selector);
