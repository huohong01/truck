...
public class RecoveryMethodFragment extends Fragment {
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        submitBtn.setBackgroundColor(getResources().getColor(R.color.primary_dark));
        ((BaseThemeActivity) getActivity()).applyTheme(submitBtn, R.color.primary_dark, background_color);
